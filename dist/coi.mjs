#!/usr/bin/env node
process.stderr.write("[agent-intercom-build] package=@dataforxyz/agent-intercom-codex version=0.10.0 target=coi sourceSha256=1aea5fbf55e45c0849101f166733a90aecd14df2f9159888c75bd2b99c8df505\n");
